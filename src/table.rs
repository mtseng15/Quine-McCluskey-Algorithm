...
pub fn table_print(table: Vec<Row>) {
...
pub fn reduce_to_prime_implicants (table: Table) -> Vec<Row> {
...
pub fn comparison (mut table: Table) -> Option<Table> {
...
// include dashes)
pub fn initial_comparison (mut table: Table) -> Table {
...
pub fn quick_sort (table: Vec<Row>) -> Vec<Row> {
